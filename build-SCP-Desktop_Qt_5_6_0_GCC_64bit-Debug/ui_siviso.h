...
public:
    ...
    void setupUi(QMainWindow *siviso)
    {
        ...
        frame->setGeometry(QRect(80, 160, 211, 61));
        ...
        Alert = new QLabel(frame_4);
        Alert->setObjectName(QStringLiteral("Alert"));
        Alert->setGeometry(QRect(10, 125, 461, 91));
...
"Verdadero", 0));
        ...
        Alert->setText(QApplication::translate("siviso", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt;\">Alerta: Bateria baja</span></p></body></html>", 0));
        ...
        label_32->setText(QApplication::translate("siviso", "<html><head/><body><p><span style=\" font-size:6pt;\">voltaje de la bateria</span></p></body></html>", 0));
        gpsLat->setText(QString());
        gpsLong->setText(QString());
        carga->setText(QString());
        label_35->setText(QApplication::translate("siviso", "<html><head/><body><p><span style=\" font-size:6pt;\">Carga de la bateria (%):</span></p></body></html>", 0));
